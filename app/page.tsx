...
export default function Home() {
  return (
    <div className="prose dark:prose-invert">
      ...
      <ul>
        <li><a className="font-mono" href="https://github.com/spilnotaxyz/chyn">spilnotaxyz/chyn</a> – a headless web3 ui component library built with shadcn and wagmi;</li>
